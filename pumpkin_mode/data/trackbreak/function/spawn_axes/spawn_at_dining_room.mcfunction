...
tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"Trying to spawn axe at dining_room...","color":"white"}]
...
execute if score dining_room axe_available matches 1 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✓ Successfully spawned axe at dining_room ","color":"green"},{"text":"(-7029, 78, 7966)","color":"aqua"}]
execute if score dining_room axe_available matches 0 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✗ Location dining_room unavailable","color":"red"}]
