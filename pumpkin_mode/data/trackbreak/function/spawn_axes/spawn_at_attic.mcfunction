...
tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"Trying to spawn axe at attic...","color":"white"}]
...
execute if score attic axe_available matches 1 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✓ Successfully spawned axe at attic ","color":"green"},{"text":"(-7077, 89, 7976)","color":"aqua"}]
execute if score attic axe_available matches 0 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✗ Location attic unavailable","color":"red"}]
