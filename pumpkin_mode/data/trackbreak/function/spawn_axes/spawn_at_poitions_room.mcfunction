...
tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"Trying to spawn axe at poitions_room...","color":"white"}]
...
execute if score poitions_room axe_available matches 1 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✓ Successfully spawned axe at poitions_room ","color":"green"},{"text":"(-7061, 78, 7992)","color":"aqua"}]
execute if score poitions_room axe_available matches 0 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✗ Location poitions_room unavailable","color":"red"}]
