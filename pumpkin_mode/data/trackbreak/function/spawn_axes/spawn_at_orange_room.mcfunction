...
tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"Trying to spawn axe at orange_room...","color":"white"}]
...
execute if score orange_room axe_available matches 1 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✓ Successfully spawned axe at orange_room ","color":"green"},{"text":"(-7046, 90, 7950)","color":"aqua"}]
execute if score orange_room axe_available matches 0 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✗ Location orange_room unavailable","color":"red"}]
