...
tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"Trying to spawn axe at church...","color":"white"}]
...
execute if score church axe_available matches 1 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✓ Successfully spawned axe at church ","color":"green"},{"text":"(-7077, 78, 7976)","color":"aqua"}]
execute if score church axe_available matches 0 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✗ Location church unavailable","color":"red"}]
