...
tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"Trying to spawn axe at ocean_room...","color":"white"}]
...
execute if score ocean_room axe_available matches 1 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✓ Successfully spawned axe at ocean_room ","color":"green"},{"text":"(-7054, 90, 7967)","color":"aqua"}]
execute if score ocean_room axe_available matches 0 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✗ Location ocean_room unavailable","color":"red"}]
