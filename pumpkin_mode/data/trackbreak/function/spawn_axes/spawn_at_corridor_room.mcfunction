...
tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"Trying to spawn axe at corridor_room...","color":"white"}]
...
execute if score corridor_room axe_available matches 1 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✓ Successfully spawned axe at corridor_room ","color":"green"},{"text":"(-7055, 78, 7970)","color":"aqua"}]
execute if score corridor_room axe_available matches 0 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✗ Location corridor_room unavailable","color":"red"}]
