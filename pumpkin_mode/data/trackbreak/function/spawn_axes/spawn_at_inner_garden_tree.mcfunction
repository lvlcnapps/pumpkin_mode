...
tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"Trying to spawn axe at inner_garden_tree...","color":"white"}]
...
execute if score inner_garden_tree axe_available matches 1 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✓ Successfully spawned axe at inner_garden_tree ","color":"green"},{"text":"(-7047, 86, 7965)","color":"aqua"}]
execute if score inner_garden_tree axe_available matches 0 run tellraw @a [{"text":"[DEBUG] ","color":"gray"},{"text":"✗ Location inner_garden_tree unavailable","color":"red"}]
